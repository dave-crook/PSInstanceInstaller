...
/****** Object:  Job [NONPROD - IndexOptimize - ALL_DATABASES]    Script Date: 3/25/2020 8:20:50 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Nonprod]    Script Date: 3/25/2020 8:20:50 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'NONPROD - IndexOptimize - ALL_DATABASES', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [IndexOptimize - ALL_DATABASES]    Script Date: 3/25/2020 8:20:50 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'NONPROD - IndexOptimize - USER_DATABASES', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=2, 
		@freq_subday_type=1, 
		...
		@schedule_uid=N'cab9c54c-1551-483c-93ac-ed1ce6929df1'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
