...
/****** Object:  Job [PROD - 1 - DatabaseIntegrityCheck - SYSTEM_DATABASES]    Script Date: 3/25/2020 8:17:24 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Prod1]    Script Date: 3/25/2020 8:17:24 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'PROD - 1 - DatabaseIntegrityCheck - SYSTEM_DATABASES', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DatabaseIntegrityCheck - SYSTEM_DATABASES]    Script Date: 3/25/2020 8:17:24 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'PROD - 1 - DatabaseIntegrityCheck - SYSTEM_DATABASES', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=64, 
		@freq_subday_type=1, 
		...
		@schedule_uid=N'4dd4c12c-0ea2-4e4a-a12c-7054b954076c'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
