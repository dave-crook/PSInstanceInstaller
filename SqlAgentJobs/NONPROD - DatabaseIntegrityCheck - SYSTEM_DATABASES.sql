...
/****** Object:  Job [NONPROD - DatabaseIntegrityCheck - SYSTEM_DATABASES]    Script Date: 3/25/2020 8:20:17 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Nonprod]    Script Date: 3/25/2020 8:20:17 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'NONPROD - DatabaseIntegrityCheck - SYSTEM_DATABASES', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DatabaseIntegrityCheck - SYSTEM_DATABASES]    Script Date: 3/25/2020 8:20:17 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'NONPROD - DatabaseIntegrityCheck - SYSTEM_DATABASES', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@schedule_uid=N'49154d1f-8cbd-4b01-8ad6-6eb1fdc1bf16'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
