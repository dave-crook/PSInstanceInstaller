...
/****** Object:  Job [PROD - 1 - DatabaseIntegrityCheck - USER_DATABASES]    Script Date: 3/25/2020 8:17:39 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Prod1]    Script Date: 3/25/2020 8:17:39 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'PROD - 1 - DatabaseIntegrityCheck - USER_DATABASES', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DatabaseIntegrityCheck - USER_DATABASES]    Script Date: 3/25/2020 8:17:40 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'PROD - 1 - DatabaseIntegrityCheck - USER_DATABASES', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=64, 
		@freq_subday_type=1, 
		...
		@schedule_uid=N'6b1bbe49-2dee-465a-a402-2278bd3c57e4'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
