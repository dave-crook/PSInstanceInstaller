...
$MasterKey = ConvertTo-SecureString -String "MayThe4ceBeWithYou!" -AsPlainText -Force
$KeePassEntryGroupPath = 'LS1-Prod/SQL'
...
$ActiveDirectoryDomain = "POLDOCREVIEW"
$OU = "OU=SQL Servers,OU=Servers,DC=poldocreview,DC=law"

#MSX and CMS
$SQLManagementServer = 'LSP-VSQL-01'
$CMDBServer = 'LSP-VSQL-01'
...
$SmtpRelay = 'relay.poldocreview.law'
...
$InstallRoot = "\\LSP-VSQL-01\INSTALLS"
